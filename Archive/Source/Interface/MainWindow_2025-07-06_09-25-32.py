...
# Created: 2025-07-05
# Last Modified: 2025-07-05  09:20PM
"""
Description: RESTORED ORIGINAL DESIGN - Anderson's Library Main Window
Restored the beautiful original blue gradient design with PySide6 compatibility fixes.
"""
...
from PySide6.QtGui import QFont, QIcon  # FIXED: QAction moved to QtGui in PySide6
...
class MainWindow(QMainWindow):
    """
    RESTORED: Anderson's Library with original beautiful blue gradient design.
    """
    ...
    def __init__(self):
        ...
        self.SetupUI()
        self.ConnectSignals()
        self.ApplyOriginalBeautifulTheme()  # RESTORED: Original design
    ...
    def SetupUI(self):
        """Setup the main user interface - RESTORED original layout."""
        # RESTORED: Original title, not "Professional Edition"
        self.setWindowTitle("Anderson's Library")
        self.setMinimumSize(1200, 800)
        
        # Start maximized like original
        self.showMaximized()
        ...
        # RESTORED: Original red status bar
        self.SetupStatusBar()
    ...
    def SetupStatusBar(self):
        """RESTORED: Setup the original red status bar."""
        self.StatusBar = QStatusBar()
        self.setStatusBar(self.StatusBar)
        # RESTORED: Original red status bar styling
    ...
    def ApplyOriginalBeautifulTheme(self):
        """RESTORED: Apply the original beautiful blue gradient theme from Legacy/Andy.py"""
        # RESTORED: The exact original stylesheet that made it beautiful
        OriginalStyleSheet = """
        * {
        ...
        self.Logger.info("RESTORED: Original beautiful blue gradient theme applied")
    ...
    def DisplayAllBooks(self):
        """Display all books using existing interface."""
        try:
    ...
    def OnFiltersChanged(self, Category, Subject=None):
        """Handle category/subject filtering."""
        try:
...
def RunApplication():
    """Run the Anderson's Library application with RESTORED original styling."""
    ...
    try:
        ...
        Logger.info("Anderson's Library Started")
